    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        form {
            ...
            /* max-width: 700px; <--- DIHAPUS SESUAI PERMINTAAN */
        }
        ...
        .modal-content {
            ...
            width: 90%;
            /* max-width: 450px; <--- DIHAPUS SESUAI PERMINTAAN (jika ini yang dimaksud tabel) */
            text-align: center;
            position: relative;
...
<body>
    ...
    <script type="text/javascript">
        ...
        (function() {
            // **Public Key EmailJS Anda yang baru sudah terpasang di sini:**
            emailjs.init("z5mBMPTLuNACM2NZV");
        })();

        // Dapatkan referensi elemen DOM menggunakan const
